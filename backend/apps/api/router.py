"""
API Router - aggregates all non-agent routes

This router includes all REST endpoints EXCEPT agent-related routes.
Agent routes are handled by the separate agent service.
"""
...
# NOTE: agents_router is NOT included here - it's in the agent service
